...
public class b_FileInputStream_readByArray {
    ...
    private static void copyTxt() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("Java_1.8_IO/src/main/resources/FileOutputStreamCopy.txt");
    ...
    private static void copyPic() throws IOException {
        // 创建流对象
        FileInputStream fis = new FileInputStream("Java_1.8_IO/src/main/resources/TD.jpg");
        FileOutputStream fos = new FileOutputStream("Java_1.8_IO/src/main/resources/CJ.jpg");
